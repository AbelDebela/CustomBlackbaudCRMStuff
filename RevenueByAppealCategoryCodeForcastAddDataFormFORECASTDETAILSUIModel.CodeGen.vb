...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'RevenueByAppealCategoryCodeForcastAddDataFormFORECASTDETAILS' data form
''' </summary>
Partial Public Class [RevenueByAppealCategoryCodeForcastAddDataFormFORECASTDETAILSUIModel]
