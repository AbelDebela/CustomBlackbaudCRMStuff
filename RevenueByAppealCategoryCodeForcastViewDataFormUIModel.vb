Public Class RevenueByAppealCategoryCodeForcastViewDataFormUIModel

    Private Sub RevenueByAppealCategoryCodeForcastViewDataFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
    ...
    Private Sub LoadAppealCategoryCode()
        ...
        Dim _totalrow As New RevenueByAppealCategoryCodeForcastViewDataFormFORECASTDETAILSUIModel
    ...
    Private Sub UpdateForcastValues()
        ...
        For Each ln In FORECASTDETAILS.Value
            For Each stf In ln.Fields
                stf.Enabled = False
            Next
        Next
    End Sub
